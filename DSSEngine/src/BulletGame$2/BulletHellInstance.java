...
public class BulletHellInstance extends GameDataBase {
	...
	public WordByRef<String> getTextureFile(int i) {
		...
		while (iterator.hasNext()) {
			WordByRef<String> currentNode = ((WordByRef) iterator
					.getCurrentNode());
			if (i == 0) {
				return currentNode;
			}
	...
	public void autoWrittenDeSerializeCode() {
		String script_strTmp = ((StringEntry) readField("script",
				new StringEntry(""))).getString();
		if (script_strTmp.length() > 0) {
			script = new TaiScriptEditor(script_strTmp);
		} else {
			script = new TaiScriptEditor(
					"");
		}
		StringEntry got254070401969733 = (StringEntry) readField("textureURLs",
				null);
		textureURLs = new TaiDAWG();
		if (got254070401969733 != null) {
			try {
				ByteArrayInputStream bais = new ByteArrayInputStream(
						decodeString(got254070401969733.getString()));
				ObjectInputStream ois = new ObjectInputStream(bais);
				textureURLs.readInTree(ois, null);
			} catch (Throwable e) {
				System.err.println("Error in Deserialization of TAIDAWG");
			}
		}
		StringEntry got254070411179842 = (StringEntry) readField(
				"extraTextularIndeces", null);
		extraTextularIndeces = new TaiDAWG();
		if (got254070411179842 != null) {
			try {
				ByteArrayInputStream bais = new ByteArrayInputStream(
						decodeString(got254070411179842.getString()));
				ObjectInputStream ois = new ObjectInputStream(bais);
		...
		String extraTextularData_strTmp = ((StringEntry) readField(
				"extraTextularData", new StringEntry(""))).getString();
	...
	public void autoWrittenSerializeCode() {
		writeField("script", new StringEntry(script != null ? script
				.hashToString() : ""));
		if (textureURLs != null) {
			try {
		...
		if (extraTextularIndeces != null) {
			try {
				...
				baos.flush();
				String encodeString = encodeString(baos.toByteArray());
				writeField("extraTextularIndeces",
						new StringEntry(encodeString));
			} catch (Throwable e) {
				;
				System.err.println("Error in taiDAWG serializations");
			}
		}
		writeField("extraTextularData", new StringEntry(
				extraTextularData != null ? hashAllToString(extraTextularData)
						: ""));
	}

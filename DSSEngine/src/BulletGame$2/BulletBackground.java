 ...
 */
public class BulletBackground extends BulletExpressionGameDB implements GameDataBase.StringBase
{
	...
	if (!key.equals("background_tilex")&&!key.equals("background_tiley")&&!key.equals("bg_m1")&&!key.equals("bg_m2")&&!key.equals("bg_m3")&&!key.equals("bg_m4")&&!key.equals("bg_m5")&&!key.equals("bg_m6")&&!key.equals("bg_m7")&&!key.equals("bg_m8")&&!key.equals("bg_m9")&&!key.equals("bg_m10")&&!key.equals("bg_m11")&&!key.equals("bg_m12")&&!key.equals("bg_m13")&&!key.equals("bg_m14")&&!key.equals("bg_m15")&&!key.equals("bg_m16")&&!key.equals("offsetX")&&!key.equals("offsetY")&&!key.equals("tintR")&&!key.equals("tintG")&&!key.equals("tintB")&&!key.equals("tintA")&&!key.equals("background")&&!key.equals("backgroundFPS")){
	...
	public void autoWrittenDeSerializeCode(){
		background_tilex = ((IntEntry)readField("background_tilex", new IntEntry(1))).getInt();
		background_tiley = ((IntEntry)readField("background_tiley", new IntEntry(1))).getInt();
		bg_m1 = ((StringEntry)readField("bg_m1", new StringEntry("1"))).getString();
		bg_m2 = ((StringEntry)readField("bg_m2", new StringEntry("0"))).getString();
		bg_m3 = ((StringEntry)readField("bg_m3", new StringEntry("0"))).getString();
		bg_m4 = ((StringEntry)readField("bg_m4", new StringEntry("0"))).getString();
		bg_m5 = ((StringEntry)readField("bg_m5", new StringEntry("0"))).getString();
		bg_m6 = ((StringEntry)readField("bg_m6", new StringEntry("1"))).getString();
		bg_m7 = ((StringEntry)readField("bg_m7", new StringEntry("0"))).getString();
		bg_m8 = ((StringEntry)readField("bg_m8", new StringEntry("0"))).getString();
		bg_m9 = ((StringEntry)readField("bg_m9", new StringEntry("0"))).getString();
		bg_m10 = ((StringEntry)readField("bg_m10", new StringEntry("0"))).getString();
		bg_m11 = ((StringEntry)readField("bg_m11", new StringEntry("1"))).getString();
		bg_m12 = ((StringEntry)readField("bg_m12", new StringEntry("0"))).getString();
		bg_m13 = ((StringEntry)readField("bg_m13", new StringEntry("0"))).getString();
		bg_m14 = ((StringEntry)readField("bg_m14", new StringEntry("0"))).getString();
		bg_m15 = ((StringEntry)readField("bg_m15", new StringEntry("0"))).getString();
		bg_m16 = ((StringEntry)readField("bg_m16", new StringEntry("1"))).getString();
		offsetX = ((StringEntry)readField("offsetX", new StringEntry("0"))).getString();
		offsetY = ((StringEntry)readField("offsetY", new StringEntry("0"))).getString();
		...
		background = ((StringEntry)readField("background", new StringEntry("null"))).getString();
		backgroundFPS = (float)((DoubleEntry)readField("backgroundFPS", new DoubleEntry(30))).getDouble();
		xFormBuffer = ((FloatArrayEntry)readField("xFormBuffer", new FloatArrayEntry(new float[]{}))).getFloatArray();
